...
- [ ] #238 part 2 — bulk **Tag** add/remove + **Set language pair**, and porting the selection model to the set-detail list for bulk **Remove from set** (absorbed from #247; needs resolving against drag-to-reorder).
