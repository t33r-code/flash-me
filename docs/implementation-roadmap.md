...
- [ ] #235 — app-wide keyboard support & polish for desktop (parent; global-shortcut ideas split into #278 Ctrl/Cmd+S, #279 `/` focus-search, #280 Ctrl/Cmd+N create, #281 `?` cheatsheet)
